...
HEALTH_FONT = pygame.font.SysFont('pluto', 40)
WINNER_FONT = pygame.font.SysFont('pluto', 100)

BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('Assets','shot_gun_sound.mp3'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join('Assets','electronic block hit.wav'))
WIN_SOUND = pygame.mixer.Sound(os.path.join('Assets','arcade_win.wav'))
...
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACE_IMAGE, (SPACESHIP_WIDTH,SPACESHIP_HEIGHT)), -90)
...
def main():
    yellow = pygame.Rect(100,310,SPACESHIP_WIDTH,SPACESHIP_HEIGHT)
    red = pygame.Rect(1180,310,SPACESHIP_WIDTH,SPACESHIP_HEIGHT)
